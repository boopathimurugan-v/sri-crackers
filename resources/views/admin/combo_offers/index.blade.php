...
<div class="d-flex justify-content-between align-items-center mb-4">
    <h2>Combo Offers</h2>
    <a href="{{ route('admin.combo-offers.create') }}" class="btn btn-primary">
        <i class="bi bi-plus-circle"></i> Add Combo Offer
    </a>
</div>
            ...
            <table class="table table-hover align-middle">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><span class="fw-bold text-success">₹{{ $offer->price }}</span></td>
                        <td>
                        ...
                        <td>
                            <div class="btn-group btn-group-sm">
                                <a href="{{ route('admin.combo-offers.edit', $offer) }}" class="btn btn-primary" title="Edit"><i class="bi bi-pencil"></i></a>
                                <form action="{{ route('admin.combo-offers.destroy', $offer) }}" method="POST" class="d-inline delete-form">
                                    @csrf
                                    @method('DELETE')
                    ...
                    @empty
                    <tr>
                        <td colspan="6" class="text-center py-4">No combo offers found.</td>
                    </tr>
                    @endforelse
                </tbody>
            </table>
