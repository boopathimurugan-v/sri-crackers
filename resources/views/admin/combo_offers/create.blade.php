...
<div class="card shadow-sm">
    <div class="card-body">
        <form action="{{ route('admin.combo-offers.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <div class="mt-4 text-end border-top pt-3">
                <button type="submit" class="btn btn-primary"><i class="bi bi-save"></i> Save Combo Offer</button>
            </div>
        </form>
    </div>
</div>
